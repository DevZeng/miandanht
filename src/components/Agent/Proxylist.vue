...
<!--           <el-table-column prop="sys" label="平台" width="200" align="center">
          </el-table-column>
          <el-table-column prop="store" label="商家" width="200" align="center">
          </el-table-column> -->
...
<!--       <el-form-item label="平台：" prop="sys">
        <el-input v-model="ratiolist.sys" type="number" placeholder="请输入百分比"> <template slot="append">%</template></el-input>
      </el-form-item>
      <el-form-item label="商家：" prop="store">
        <el-input v-model="ratiolist.store" type="number" placeholder="请输入百分比"> <template slot="append">%</template></el-input>
      </el-form-item> -->
...
<el-col>
  <el-dialog title="佣金详情" :visible.sync="dialogSeeVisible" width="1200px" center>
    ...
    <el-table :data="currow" border stripe size="mini" id="out-table">
      <el-table-column prop="person.nickname" label="用户" min-width="100" align="center">
      </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getlist() {
        var allParams = '?page='+ this.currentPage + '&limit=' + this.limit + '&search=' + this.filters.name+ '&is_proxy=1';
